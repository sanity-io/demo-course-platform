...
// demo-course-platform.sanity.dev is the frontend domain
// demo-course-platform-studio.sanity.dev is the studio domain
export const enableUrl = process.env.SANITY_STUDIO_VERCEL_ENV
  ? `https://${
      process.env.SANITY_STUDIO_VERCEL_ENV === 'production'
        ? 'demo-course-platform.sanity.dev' // I don't understand why the primary domain doesn't have a variable
